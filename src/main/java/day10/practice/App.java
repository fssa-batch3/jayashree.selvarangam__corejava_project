...
public static void main(String[] args) {
		...
		String email1 = "Jaya@gmail.com";
		String email2 = "Jaya@gmail.com";
		...
		//Question 2
			...
			User user1 = new User(1, "jay", "jay@gmail.com");
			User user2 = new User(2, "jaya", "jaya@email.com");
			User user3 = new User(3, "jayashree", "jayashree@gmail.com");
			try {
